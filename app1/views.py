...
def index(request):
	response = """<h1>Gaebar Test App for app-engine-patch</h1>
	<p>For more info see the <a href="http://github.com/aral/gaebar/tree/master">Gaebar project</a>, <a href="http://code.google.com/p/app-engine-patch/">app-engine-patch</a>, and <a href="http://code.google.com/appengine/">Google App Engine</a>.</p>
	"""
